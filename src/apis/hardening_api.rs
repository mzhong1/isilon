...
pub trait HardeningApi {
    ...
    ) -> Box<dyn Future<Output = Result<crate::models::CreateHardeningApplyItemResponse, Error>>>;
    fn create_hardening_resolve_item(
        &self,
        hardening_resolve_item: crate::models::HardeningResolveItem,
        accept: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::CreateHardeningResolveItemResponse, Error>>>;
    fn create_hardening_revert_item(
        &self,
        hardening_revert_item: crate::models::Empty,
        force: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::CreateHardeningRevertItemResponse, Error>>>;
    fn get_hardening_state(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::HardeningState, Error>>>;
