...
pub trait NetworkGroupnetsApi {
    ...
    fn get_groupnet_subnet(
        ...
        groupnet_subnet_id: &str,
        groupnet: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::GroupnetSubnets, Error>>>;
    fn get_subnets_subnet_pool(
        &self,
        subnets_subnet_pool_id: &str,
        groupnet: &str,
        subnet: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SubnetsSubnetPools, Error>>>;
    ...
    fn list_subnets_subnet_pools(
        ...
        limit: i32,
        dir: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SubnetsSubnetPoolsExtended, Error>>>;
