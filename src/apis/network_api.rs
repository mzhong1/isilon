...
pub trait NetworkApi {
    ...
    fn get_network_dnscache(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::NetworkDnscache, Error>>>;
    fn get_network_external(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::NetworkExternal, Error>>>;
    fn get_network_groupnet(
        &self,
        network_groupnet_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::NetworkGroupnets, Error>>>;
    ...
    fn get_network_pools(
        ...
        groupnet: &str,
        dir: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::NetworkPools, Error>>>;
    ...
    fn get_network_subnets(
        ...
        dir: &str,
        resume: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::GroupnetSubnetsExtended, Error>>>;
    fn list_network_groupnets(
        ...
        dir: &str,
        resume: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::NetworkGroupnetsExtended, Error>>>;
