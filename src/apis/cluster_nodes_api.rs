...
pub trait ClusterNodesApi {
    ...
    fn get_drives_drive_firmware(
        ...
        lnn: i32,
        driveid: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::DrivesDriveFirmware, Error>>>;
    fn get_node_drive(
        &self,
        node_drive_id: &str,
        lnn: i32,
        timeout: f32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeDrives, Error>>>;
    fn get_node_driveconfig(
        &self,
        lnn: i32,
        timeout: f32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeDriveconfig, Error>>>;
    fn get_node_drives(
        &self,
        lnn: i32,
        timeout: f32,
    ...
    fn get_node_drives_purposelist(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeDrivesPurposelist, Error>>>;
    fn get_node_hardware(
        &self,
        lnn: i32,
        timeout: f32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeHardware, Error>>>;
    fn get_node_hardware_fast(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeHardwareFast, Error>>>;
    fn get_node_partitions(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodePartitions, Error>>>;
    fn get_node_sensors(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeSensors, Error>>>;
    fn get_node_sled(
        &self,
        node_sled_id: &str,
        lnn: i32,
        timeout: f32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeSleds, Error>>>;
    fn get_node_sleds(
        &self,
        lnn: i32,
        timeout: f32,
    ...
    fn get_node_state(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeState, Error>>>;
    fn get_node_state_readonly(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeStateReadonly, Error>>>;
    fn get_node_state_servicelight(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeStateServicelight, Error>>>;
    fn get_node_state_smartfail(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeStateSmartfail, Error>>>;
    fn get_node_status(
        &self,
        lnn: Option<i32>,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeStatus, Error>>>;
    fn get_node_status_batterystatus(
        &self,
        lnn: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::NodeStatusBatterystatus, Error>>>;
    fn list_drives_drive_firmware_update(
        &self,
        lnn: i32,
        driveid: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::DrivesDriveFirmwareUpdate, Error>>>;
