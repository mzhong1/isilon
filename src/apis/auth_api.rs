...
pub trait AuthApi {
    ...
    fn create_mapping_identity_0(
        ...
        _type: &str,
        zone: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::MappingIdentities, Error>>>;
    ...
    fn delete_auth_role(&self, auth_role_id: &str) -> Box<dyn Future<Output = Result<(), Error>>>;
    fn delete_auth_user(
        &self,
        auth_user_id: &str,
        cached: bool,
    ...
    fn get_auth_access_user(
        ...
        zone: &str,
        numeric: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthAccess, Error>>>;
    fn get_auth_group(
        &self,
        auth_group_id: &str,
        cached: bool,
        ...
        zone: &str,
        provider: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthGroups, Error>>>;
    fn get_auth_id(&self) -> Box<dyn Future<Output = Result<crate::models::AuthId, Error>>>;
    fn get_auth_ldap_template(
        &self,
        auth_ldap_template_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthLdapTemplates, Error>>>;
    fn get_auth_ldap_templates(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthLdapTemplatesExtended, Error>>>;
    fn get_auth_log_level(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthLogLevel, Error>>>;
    fn get_auth_netgroup(
        ...
        zone: &str,
        provider: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthNetgroups, Error>>>;
    fn get_auth_privileges(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthPrivileges, Error>>>;
    fn get_auth_role(
        &self,
        auth_role_id: &str,
        resolve_names: bool,
    ...
    fn get_auth_user(
        ...
        zone: &str,
        provider: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthUsers, Error>>>;
    fn get_auth_wellknown(
        &self,
        auth_wellknown_id: &str,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthWellknowns, Error>>>;
    ...
    fn get_mapping_dump(
        ...
        nocreate: bool,
        zone: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::MappingDump, Error>>>;
    ...
    ) -> Box<dyn Future<Output = Result<crate::models::MappingUsersLookup, Error>>>;
    fn get_mapping_users_rules(
        &self,
        zone: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::MappingUsersRules, Error>>>;
    fn get_providers_ads_by_id(
        &self,
        providers_ads_id: &str,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersAds, Error>>>;
    fn get_providers_file_by_id(
        &self,
        providers_file_id: &str,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersFile, Error>>>;
    fn get_providers_krb5_by_id(
        &self,
        providers_krb5_id: &str,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersKrb5, Error>>>;
    fn get_providers_ldap_by_id(
        &self,
        providers_ldap_id: &str,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersLdap, Error>>>;
    fn get_providers_local(
        &self,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersLocal, Error>>>;
    ...
    fn get_providers_nis_by_id(
        ...
        providers_nis_id: &str,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersNis, Error>>>;
    fn get_providers_summary(
        &self,
        groupnet: &str,
        zone: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersSummary, Error>>>;
    fn get_settings_acls(
        &self,
        preset: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SettingsAcls, Error>>>;
    fn get_settings_global(
        &self,
        scope: &str,
        zone: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SettingsGlobal, Error>>>;
    fn get_settings_krb5_defaults(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::SettingsKrb5Defaults, Error>>>;
    fn get_settings_krb5_domain(
        &self,
        settings_krb5_domain_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SettingsKrb5Domains, Error>>>;
    fn get_settings_krb5_realm(
        &self,
        settings_krb5_realm_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SettingsKrb5Realms, Error>>>;
    fn get_settings_mapping(
        &self,
        scope: &str,
        zone: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::SettingsMapping, Error>>>;
    fn list_auth_groups(
        &self,
        domain: &str,
        zone: &str,
        ...
        provider: &str,
        query_member_of: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthGroupsExtended, Error>>>;
    fn list_auth_roles(
        &self,
        sort: &str,
        resolve_names: bool,
        ...
        dir: &str,
        resume: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthRolesExtended, Error>>>;
    fn list_auth_users(
        &self,
        domain: &str,
        zone: &str,
        ...
        provider: &str,
        query_member_of: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::AuthUsersExtended, Error>>>;
    fn list_providers_ads(
        &self,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersAdsExtended, Error>>>;
    ...
    fn list_providers_krb5(
        &self,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersKrb5Extended, Error>>>;
    ...
    fn list_providers_nis(
        &self,
        scope: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ProvidersNisExtended, Error>>>;
...
impl<C: hyper::client::connect::Connect + 'static> AuthApi for AuthApiClient<C> {
    ...
    fn update_providers_nis_by_id(
        ...
        providers_nis_id_params: crate::models::ProvidersNisIdParams,
        providers_nis_id: &str,
    ) -> Box<Future<Output = Result<(), Error>>> {
        let uri = format!(
            "{}/platform/3/auth/providers/nis/{ProvidersNisId}",
            self.configuration.base_path,
            ProvidersNisId = providers_nis_id
