...
pub trait FsaResultsApi {
    fn get_histogram_stat_by(
        ...
        id: &str,
        stat: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::HistogramStatBy, Error>>>;
    ...
    fn get_result_directories(
        ...
        comp_report: i32,
        dir: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ResultDirectories, Error>>>;
    ...
    fn get_result_histogram(
        &self,
        id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ResultHistogram, Error>>>;
    ...
    fn get_result_top_dir(
        ...
        comp_report: i32,
        dir: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::ResultTopDirs, Error>>>;
