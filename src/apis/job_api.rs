...
pub trait JobApi {
    ...
    ) -> Box<dyn Future<Output = Result<crate::models::CreateJobJobResponse, Error>>>;
    ...
    fn get_job_events(
        ...
        limit: i32,
        key: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobEvents, Error>>>;
    fn get_job_job(
        &self,
        job_job_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobJobs, Error>>>;
    fn get_job_job_summary(
        &self,
    ) -> Box<dyn Future<Output = Result<crate::models::JobJobSummary, Error>>>;
    fn get_job_policy(
        &self,
        job_policy_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobPolicies, Error>>>;
    fn get_job_recent(
        &self,
        timeout_ms: i32,
        limit: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::JobRecent, Error>>>;
    fn get_job_reports(
        &self,
        begin: i32,
        end: i32,
        ...
        key: &str,
        verbose: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::JobReports, Error>>>;
    fn get_job_statistics(
        &self,
        devid: i32,
        job_id: i32,
    ) -> Box<dyn Future<Output = Result<crate::models::JobStatistics, Error>>>;
    fn get_job_type(
        &self,
        job_type_id: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobTypes, Error>>>;
    fn get_job_types(
        &self,
        sort: &str,
        show_all: bool,
        dir: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobTypesExtended, Error>>>;
    fn list_job_jobs(
        &self,
        sort: &str,
        resume: &str,
        ...
        limit: i32,
        dir: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobJobsExtended, Error>>>;
    fn list_job_policies(
        ...
        dir: &str,
        resume: &str,
    ) -> Box<dyn Future<Output = Result<crate::models::JobPoliciesExtended, Error>>>;
    fn update_job_job(
        &self,
