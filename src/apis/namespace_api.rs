...
pub trait NamespaceApi {
    fn copy_directory(
        ...
        merge: bool,
        _continue: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::CopyErrors, Error>>>;
    fn copy_file(
        &self,
    ...
    fn get_acl(
        ...
        acl: bool,
        nsaccess: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::NamespaceAcl, Error>>>;
    ...
    fn get_directory_contents(
        ...
        _type: &str,
        hidden: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::NamespaceObjects, Error>>>;
    ...
    fn get_worm_properties(
        ...
        worm_file_path: &str,
        worm: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::WormProperties, Error>>>;
    fn list_access_points(
        &self,
        versions: bool,
    ) -> Box<dyn Future<Output = Result<crate::models::NamespaceAccessPoints, Error>>>;
    fn move_directory(
        &self,
        directory_path: &str,
